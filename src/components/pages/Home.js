...
export default function Home() {
  return (
    <div class='body' style={{textAlign:'center'}}>
      ...
      <p>I began this journey by signing up for a full-time 90 day bootcamp course provided
        by the Univercity of Central Florida. I had NO prior knowledge of coding, and only
        had a surface/hobbyist level of knowledge of computers. The bootcamp started simple
        ...
        month felt like the longest month, </p>
